    ...
    <form action="../admin/task_status_process.php?idTask=<?php echo $id ?>" method="post" enctype= multipart/form-data>
        <div class="card col-md-6 mx-sm-auto" id="box">
            <div class="card-header bg-dark text-white rounded">
                <h1 class="text-center mb-3">REJECTED</h1>
            </div>
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <textarea id="description" name="description" rows="4" class="form-control" placeholder="Mô tả"><?php echo $task['description_task'] ?></textarea>
                </div>
                <div class="form-group">
